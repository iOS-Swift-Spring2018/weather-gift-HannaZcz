...
//        handleLocationAuthorizationStatus(status: status)
    ...
    func handleLocationAuthorizationStatus(status: CLAuthorizationStatus) {
        ...
        case .denied:
            showAlertToPrivacySettings(title: "User has not authroized location services", message: "Select 'Settings' below to open device settings and enable location services for this app.")
        case .restricted:
